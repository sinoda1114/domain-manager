...
export default async function Home() {
  ...
  return <main className="app-shell">
    <header className="masthead"><a className="wordmark" href="#overview"><Image className="wordmark-icon" src="/icon.svg" alt="" width={30} height={30} priority />Domain Manager</a><nav aria-label="主なメニュー">{hasManagedDomains && <a href="#domains"><i className="ui-icon icon-domains" />サブドメイン</a>}{hasManagedDomains && <a href="#operations"><i className="ui-icon icon-history" />履歴</a>}</nav><div><i className="connection-dot" />接続済み <LogoutButton /></div></header>
