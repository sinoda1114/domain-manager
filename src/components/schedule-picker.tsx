...
/** Keep the apply button's enabled state close to the fresh clock used in apply. */
...
export function readWallNow(date = new Date()) {
  return parseWall(toWallValue(date));
}

export function isFutureSchedule(draft: Date, now: Date) {
